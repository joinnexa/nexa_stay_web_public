        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="bg-white rounded-[22px] border border-nexa-line shadow-nexa-sm overflow-hidden">
            ...
            <div className="bg-gradient-to-br from-nexa-ink to-nexa-ink-2 p-8">
              <h1 className="text-white text-2xl font-display font-bold mb-1">Profile</h1>
              <p className="text-white/70 text-sm">View and update your information</p>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="flex flex-col items-center mb-10">
                ...
                <p className="text-sm text-nexa-ink-4 mt-2">
                  {uploading ? "Uploading…" : "Tap camera to change photo (max 5MB)"}
                </p>
              </div>
              ...
              <form onSubmit={handleSaveProfile} className="space-y-6">
                <div>
                  ...
                  />
                  <p className="text-xs text-nexa-ink-4 mt-1">Locked</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-nexa-ink-4 mt-1">Tap to change (OTP verification required)</p>
                ...
                <div>
                  <label className="text-sm font-medium text-nexa-ink mb-2 block">KYC status</label>
                  <span
                    className={cn(
                ...
                <div className="pt-4 flex gap-3">
                  ...
                  <Button variant="outline" asChild>
                    <Link href="/listings">Back to Stays</Link>
                  </Button>
                </div>
              </form>
            </div>
