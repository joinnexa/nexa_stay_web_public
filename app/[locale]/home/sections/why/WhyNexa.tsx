...
export const WhyNexaSection = () => {
  const { t } = useLanguage();
  const whyCards = [
    { icon: "🎬", titleKey: "home.why.verifiedWalkthrough", descKey: "home.why.verifiedWalkthroughDesc" },
    { icon: "🪪", titleKey: "home.why.verifiedIdentity", descKey: "home.why.verifiedIdentityDesc" },
    { icon: "🔑", titleKey: "home.why.clearCheckin", descKey: "home.why.clearCheckinDesc" },
    { icon: "⚖️", titleKey: "home.why.fairProtection", descKey: "home.why.fairProtectionDesc" },
  ];
  return (
