...
export default function HostPage() {
  ...
  const { t: tHost, localePath } = useLanguage();
    ...
    try {
      ...
      const body = {
        ...
        check_in_contact: {
          ...
          phone: normalizeMoroccanPhone(contactPhone),
          role: contactRole,
        },
        media,
      };
          ...
          <div className="max-w-[600px]">
            ...
            {contentStep === 4 && (
              <HostVerificationStep
                ...
                onLoginRedirect={() => router.push(`${localePath("/registration")}?redirect=${encodeURIComponent(localePath("/host"))}`)}
              />
            )}
            ...
            {contentStep === 6 && (
              <div>
                ...
                <div className="flex gap-3">
                  {addListingOnly ? (
                    <Button variant="ghost" asChild><Link href={localePath("/host/dashboard")}>← Back</Link></Button>
                  ) : (
              ...
              <div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <PhoneInput value={getLocalPhonePart(contactPhone)} onChange={(v) => setContactPhone(v)} placeholder="6 XX XX XX XX" />
                  </div>
                  <div>
            ...
            {contentStep === 12 && listingSubmitted && (
              <div className="text-center py-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Button asChild>
                    <Link href={localePath("/host/dashboard")}>View your listings</Link>
                  </Button>
